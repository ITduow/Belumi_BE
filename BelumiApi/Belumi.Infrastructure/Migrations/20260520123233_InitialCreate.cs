    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MakeupCatalogItems", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IngredientLookupLimit = table.Column<int>(type: "integer", nullable: false),
                    MakeupConsultationLimit = table.Column<int>(type: "integer", nullable: false),
                    CanUseAdvancedAnalysis = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImageUrl = table.Column<string>(type: "text", nullable: true),
                    SuitableSkinTypes = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BeautyProfiles", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BeautyProfiles_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WarningNotes = table.Column<string>(type: "text", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_IngredientLookups_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StylePreference = table.Column<string>(type: "text", nullable: false),
                    Note = table.Column<string>(type: "text", nullable: true),
                    AiResult = table.Column<string>(type: "text", nullable: false),
                    LipColorSuggestion = table.Column<string>(type: "text", nullable: false),
                    FoundationSuggestion = table.Column<string>(type: "text", nullable: false),
                    EyeMakeupSuggestion = table.Column<string>(type: "text", nullable: false),
                    BlushSuggestion = table.Column<string>(type: "text", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MakeupConsultations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MakeupConsultations_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AiResult = table.Column<string>(type: "text", nullable: true),
                    MorningRoutine = table.Column<string>(type: "text", nullable: true),
                    NightRoutine = table.Column<string>(type: "text", nullable: true),
                    RecommendedIngredients = table.Column<string>(type: "text", nullable: true),
                    AvoidIngredients = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IngredientLookups_UserId",
                table: "IngredientLookups",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_MakeupConsultations_UserId",
                table: "MakeupConsultations",
                column: "UserId");
