...
namespace Belumi.Infrastructure.Migrations
{
    ...
    [Migration("20260717130950_AddVoucherDiscountTypeAndUsageLimit")]
    partial class AddVoucherDiscountTypeAndUsageLimit
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Belumi.Core.Entities.BeautyProfile", b =>
                {
                    ...
                    b.Property<string>("AvoidedIngredients")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("SkinSensitivity")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Belumi.Core.Entities.Ingredient", b =>
                {
                    ...
                    b.Property<string>("NotForSkin")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<string>("SuitableSkin")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Belumi.Core.Entities.Voucher", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Belumi.Core.Entities.VoucherUsage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Belumi.Core.Entities.Payment", b =>
                {
                    ...
                    b.HasOne("Belumi.Core.Entities.Voucher", "Voucher")
                        .WithMany()
            ...
            modelBuilder.Entity("Belumi.Core.Entities.VoucherUsage", b =>
                {
                    b.HasOne("Belumi.Core.Entities.Payment", "Payment")
                        .WithMany()
